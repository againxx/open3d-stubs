...
class Semantic3D(BaseDataset):
    ...
    outdoor scenes.
    """
    def __init__(self, dataset_path, name=..., cache_dir=..., use_cache=..., num_points=..., class_weights=..., ignored_label_inds=..., val_files=..., test_result_folder=..., **kwargs) -> None:
    ...
    def get_split(self, split): # -> Semantic3DSplit:
        ...
