...
class Toronto3D(BaseDataset):
    ...
    def __init__(self, dataset_path, name=..., cache_dir=..., use_cache=..., num_points=..., class_weights=..., ignored_label_inds=..., train_files=..., val_files=..., test_files=..., test_result_folder=..., **kwargs) -> None:
